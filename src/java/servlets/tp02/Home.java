...
public class Home extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<img src='luiz.jpg' width='100px' height='100px' src='guy.jpg' class='img-circle'>");
            out.println("<h4>Luiz F. Spinelli</h4>");
            out.println("<p>Trabalhou na implementação da página de Juros Compostos</p>");
            out.println("</div>");
            out.println("<div class='col-lg-4'>");
            out.println("<img src='otavio.jpg'  width='100px' height='100px' src='guy.jpg' class='img-circle'>");
            out.println("<h4>Otavio S. Guimarães</h4>");
            out.println("<p>Trabalhou na home e estilização das paginas</p>");
            out.println("</div>");
            out.println("<div class='col-lg-4'>");
            out.println("<img src='rafael.jpg' width='100px' height='100px' src='guy.jpg' class='img-circle'>");
